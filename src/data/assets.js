...
export const ASSETS = [
  ...
  },
  {
    ...
    note: "A 31× move, but it occupies 29 months — the costliest real estate on the chronograph.",
    pivots: [
  ...
  },
  {
    ...
    note: "Two legs at the far end of the chronograph — and the only ones still running.",
    pivots: [
